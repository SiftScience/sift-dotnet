    ...
    public class Test
    {
        ...
        public void TestCreateOrderEventWithWirePaymentMethod()
        {
            ...
            Assert.Equal("{\"$type\":\"$create_order\",\"$user_id\":\"test_dotnet_fintech_payment_methods\",\"$session_id\":\"gigtleqddo84l8cm15qe4il\"," +
                                 "\"$order_id\":\"12345\",\"$payment_methods\":[{\"$payment_type\":\"$wire_credit\",\"$account_holder_name\":\"John Doe\"," +
                                 "\"$account_number_last5\":\"12345\",\"$bank_name\":\"Chase\",\"$bank_country\":\"US\",\"$swift_id\":\"CHASUS33XX\"}],\"foo\":\"bar\"}",
                                 createOrder.ToJson());
