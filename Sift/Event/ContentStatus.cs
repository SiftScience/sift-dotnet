...
namespace Sift
{
    ...
    public partial class ContentStatus : SiftEvent
    {
    }
}
//----------------------
...
namespace Sift
{
    ...
    public partial class ContentStatus 
    {
        ...
        public string type { get; set; } = "$content_status";
        ...
        public static ContentStatus FromJson(string data)
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<ContentStatus>(data);
        }
