...
namespace Sift
{
    ...
    public partial class AddPromotion : SiftEvent
    {
    }
}
//----------------------
...
namespace Sift
{
    ...
    public partial class AddPromotion 
    {
        ...
        public string type { get; set; } = "$add_promotion";
        ...
        public static AddPromotion FromJson(string data)
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<AddPromotion>(data);
        }
