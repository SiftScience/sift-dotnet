...
namespace Sift
{
    ...
    public partial class UpdateOrder : SiftEvent
    {
    }
}
//----------------------
...
namespace Sift
{
    ...
    public partial class UpdateOrder 
    {
        ...
        public string type { get; set; } = "$update_order";
        ...
        public static UpdateOrder FromJson(string data)
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<UpdateOrder>(data);
        }
