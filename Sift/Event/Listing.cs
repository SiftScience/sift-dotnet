...
namespace Sift
{
    ...
    public partial class Listing : SiftEntity
    {
    }
}
//----------------------
...
namespace Sift
{
    ...
    public partial class Listing 
    {
        ...
        [Newtonsoft.Json.JsonProperty("$listed_items", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public System.Collections.ObjectModel.ObservableCollection<Item> listed_items { get; set; }
        ...
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<Listing>(data);
        }
