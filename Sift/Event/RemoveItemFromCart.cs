...
namespace Sift
{
    ...
    public partial class RemoveItemFromCart : SiftEvent
    {
    }
}
//----------------------
...
namespace Sift
{
    ...
    public partial class RemoveItemFromCart 
    {
        ...
        public string type { get; set; } = "$remove_item_from_cart";
        ...
        public static RemoveItemFromCart FromJson(string data)
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<RemoveItemFromCart>(data);
        }
