...
namespace Sift
{
    ...
    public partial class AddItemToCart : SiftEvent
    {
    }
}
//----------------------
...
namespace Sift
{
    ...
    public partial class AddItemToCart 
    {
        [Newtonsoft.Json.JsonProperty("$type", Required = Newtonsoft.Json.Required.Always)]
        [System.ComponentModel.DataAnnotations.Required(AllowEmptyStrings = true)]
        public string type { get; set; } = "$add_item_to_cart";
        ...
        public static AddItemToCart FromJson(string data)
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<AddItemToCart>(data);
        }
