...
namespace Sift.Test.Framework4_8
{
    public class Test
    {
        private readonly string TestSupportFilesPath = new DirectoryInfo(Environment.CurrentDirectory).Parent.Parent.Parent.FullName +
            "\\TestRequestBody\\";
        [Fact]
